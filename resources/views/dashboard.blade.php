                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">Nasabah Belum Dikunjungi</h6>
                                        <h6 class="font-extrabold mb-0">{{ count(value: $nasabah_belum_kunjungan) }}</h6>
                                        <a href="/nasabah?filter=belum_dikunjungi" class="stretched-link"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
