    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('statuskunjungan.index') }}" method="get">
                    ...
                    <div class="col-3">  
						{!! button('statuskunjungan.create', $title) !!}  
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('statuskunjungan.show','', $item->id) !!}
										{!! button('statuskunjungan.edit', $title, $item->id) !!}
                                        {!! button('statuskunjungan.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
