    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('dinas.index') }}" method="get">
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('dinas.show','', $item->id) !!}
										{!! button('dinas.edit', $title, $item->id) !!}
                                        {!! button('dinas.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
