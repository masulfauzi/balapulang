    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('statuspinjaman.update', $statuspinjaman->id) }}" method="POST">
                    <div class="form-body">
                        @csrf @method('patch')
                        ...
                        <div class="offset-md-3 ps-2">
                            ...
                            <a href="{{ route('statuspinjaman.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
